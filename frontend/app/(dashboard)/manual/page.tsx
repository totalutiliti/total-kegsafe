...
const sections: ManualSection[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            '  • Recebimento: IN_TRANSIT → IN_YARD (chegada ao pátio da fábrica)',
            '  • Triagem: IN_YARD → ACTIVE (higienizado e disponível para expedição)',
        ...
        tips: [
            ...
            'O ciclo é incrementado quando o barril sai de "No Pátio" para "Ativo" (após triagem/higienização)',
